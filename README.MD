...
flowchart TD
   ...
   subgraph main.py
      direction TB
      A --> B[DataScraper:Scrape Data from API]
      B --> C[DataLoader: Load Data into CSV Files]
      C --> D[DataProcessor: Clean and process raw data]
      D --> E[ModelTrainer: Train ML Model]
   end
